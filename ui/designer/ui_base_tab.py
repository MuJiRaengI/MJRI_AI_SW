...
################################################################################
## Form generated from reading UI file 'base_tabDZVXhw.ui'
##
...
class Ui_wdgt_base_tab(object):
    def setupUi(self, wdgt_base_tab):
        ...
        self.groupBox.setMaximumSize(QSize(600, 400))
        ...
        self.gridLayout.addWidget(self.btn_close, 1, 5, 1, 1)
