...
################################################################################
## Form generated from reading UI file 'contributorsBpFgef.ui'
##
...
class Ui_Contributors(object):
    def setupUi(self, Contributors):
        ...
        self.lbl_youtube.setFont(font1)
        ...
        self.gridLayout.addWidget(self.line_3, 2, 3, 3, 1)
        ...
        self.gridLayout.addWidget(self.line_2, 2, 1, 3, 1)
